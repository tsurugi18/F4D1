...
\begin{proposition}
  The map defined in Definition \ref{definition_tensoring_multilinear}, a bilinear form which is associative (ie. $(\varphi\otimes\psi)\otimes\chi = \varphi\otimes(\psi\otimes\chi)$).
\end{proposition}
...
\begin{align*}
  \Omega^\bullet(\M)=\{\text{forms smooth up to $\partial\M$}\},\\
